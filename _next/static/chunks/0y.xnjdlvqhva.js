...
`,b=(0,o.styled)(i.motion.div)`
    ...
    align-items: center;
    justify-content: center;
`,j=(0,o.styled)(i.motion.div)`
    font-size: 40px;
    font-weight: 800;
`,v=(0,o.styled)(i.motion.h2)`
    font-size: 12px;
    font-weight: 600;
    color: #fff;
    letter-spacing: 1px;
...
`,k=(0,o.styled)(i.motion.div)`
    ...
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
`,S={months:0,days:0,hours:0,minutes:0,seconds:0};function T(e,t,r){let n=new Date,i=new Date(e),o=i.getTime()-n.getTime();if(o<=0)return S;let a=Math.floor(o/1e3)%60,s=Math.floor(o/6e4)%60,l=Math.floor(o/36e5)%24,c=new Date(n),u=0;for(;;){let e=new Date(c);if(e.setMonth(e.getMonth()+1),e>i)break;u++,c.setMonth(c.getMonth()+1)}let d=Math.floor((i.getTime()-c.getTime())/864e5);return 0===a&&0===s&&0===l&&0===d&&0===u&&(r(!0),setTimeout(()=>t(),5e3)),{months:u,days:d,hours:l,minutes:s,seconds:a}}let M={position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",fontSize:"inherit",fontWeight:"inherit",background:"linear-gradient(to right, #b4d2dd, #1485e2)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text"};function P({value:e}){let n=(0,r.useRef)(e),[i,o]=(0,r.useState)({current:e,prev:e}),[a,s]=(0,r.useState)("idle");(0,r.useEffect)(()=>{e!==n.current&&(o({prev:n.current,current:e}),n.current=e,requestAnimationFrame(()=>{s("animating")}))},[e]),(0,r.useEffect)(()=>{if("animating"===a){let e=setTimeout(()=>s("idle"),450);return()=>clearTimeout(e)}},[a]);let l="animating"===a;return(0,t.jsxs)("span",{style:{display:"inline-block",position:"relative",width:"1ch",height:"1.2em",overflow:"hidden"},children:[(0,t.jsx)("span",{style:{...M,transition:l?"transform 0.4s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s ease":"none",transform:l?"translateY(-100%)":"translateY(0)",opacity:+!l},children:l?i.prev:i.current}),l&&(0,t.jsx)("span",{style:{...M,animation:"flipDown 0.4s cubic-bezier(0.4, 0, 0.2, 1) forwards"},children:i.current})]})}function R({value:e}){return(0,t.jsx)("span",{style:{display:"flex",gap:10},children:e.split("").map((e,r)=>(0,t.jsx)(P,{value:e},r))})}let C=[{key:"months",label:"Mês"},{key:"days",label:"Dia"},{key:"hours",label:"Horas"},{key:"minutes",label:"Minutos"},{key:"seconds",label:"Segundos"}];function O({setFinallyRaffle:e,refresh:n,dateRaffle:i}){let[o,a]=(0,r.useState)(S);return(0,r.useEffect)(()=>{let t;return i&&(a(T(i,n,e)),t=setInterval(()=>a(T(i,n,e)),1e3)),()=>t&&clearInterval(t)},[i]),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:`
        @keyframes flipDown {
          from { transform: translateY(100%); opacity: 0; }
          to { transform: translateY(0); opacity: 1; }
        }
      `}),(0,t.jsx)(y,{children:C.map((e,n)=>(0,t.jsxs)(r.Fragment,{children:[(0,t.jsxs)(b,{children:[(0,t.jsx)(j,{children:(0,t.jsx)(R,{value:String(o[e.key]).padStart(2,"0")})}),(0,t.jsx)(v,{children:e.label})]}),n<C.length-1&&(0,t.jsx)(w,{children:":"})]},e.key))})]})}var E=e.i(7670);let z=({name:e,filled:n=!1,staticMarkup:i=!1,className:o="",...a})=>{let s=(0,r.useRef)(null);return(0,r.useEffect)(()=>{document.fonts.load("24px Material Symbols Outlined").then(()=>{s.current&&(s.current.innerText=e)})},[]),(0,t.jsx)("i",{ref:s,className:(0,E.clsx)(o,"material-symbols-outlined min-w-6 min-h-6",{"filled-icon":n}),...a,children:i?e:null})},A=({icon:e,title:r,description:n,children:i})=>(0,t.jsxs)(d,{style:{gap:10},children:[(0,t.jsx)(p,{children:(0,t.jsx)(z,{name:e,style:{fontSize:35,fontWeight:"bold",color:"#278bff"}})}),(0,t.jsx)("div",{style:{flex:1,paddingRight:10},children:(0,t.jsxs)(u,{style:{gap:15},children:[(0,t.jsx)("span",{style:{fontWeight:"bold",fontSize:16},children:r}),(0,t.jsx)("span",{style:{fontSize:14},children:n}),i]})})]}),L=new Audio("/assets/tick_tack.m4a");e.s(["default",0,function(){let e,[n,i]=(0,r.useState)(!0),[o,d]=(0,r.useState)(!1),[p,y]=(0,r.useState)({date:null,active:!1,finished:!1,total_participants:0,winner_user_name:null,winner_user_picture:null}),b=()=>{i(!0),fetch("https://web.mexpenses.com.br/api/v1/user/raffle/current",{headers:{"key-platform":"bad7ec02-289a-4c54-a7f6-5b540539c1b5-1fe3050f-d6b3-49ee-8812-35b22e0f4544"}}).then(e=>e.json()).then(e=>{let t=!!e.date&&new Date(e.date).getTime()<=new Date().getTime();t&&d(!0),t&&!e.winner_user_name&&setTimeout(()=>b(),5e3),y(e)}).catch(console.log).finally(()=>i(!1))},j=(0,r.useRef)(!1);(0,r.useEffect)(()=>{j.current||(j.current=!0,b())},[]),(0,r.useEffect)(()=>{let e=()=>{let e=L.duration-L.currentTime;e<=1.5?L.volume=Math.max(0,e/1.5):L.volume=1};return p&&p?.active&&!p?.finished?(L.loop=!0,L.play().catch(()=>{}),L.addEventListener("timeupdate",e)):(L.pause(),L.currentTime=0),()=>{L.removeEventListener("timeupdate",e),L.pause()}},[p]);let v=(e=navigator.userAgent,/iPad|iPhone|iPod/.test(e)?"https://apps.apple.com/br/app/mexpenses/id6757622280":/Android/.test(e)?"https://play.google.com/store/apps/details?id=com.appmexpenses":"https://app.mexpenses.com.br/#/auth/register/basic");return(0,t.jsx)(a,{children:(0,t.jsx)(s,{children:(0,t.jsxs)(l,{children:[(0,t.jsx)(c,{children:"Próximo sorteio exclusivo para assinantes fidelizados"}),(0,t.jsx)(h,{children:"🎉 Mascote Mex + Presente misterioso 🧸🎁"}),o&&!p?.winner_user_name&&(0,t.jsx)(x,{children:(0,t.jsx)("b",{children:"Algoritmo sorteando o vencedor ...🎲"})}),!n&&!p?.date&&(0,t.jsx)(x,{children:(0,t.jsx)("b",{children:"Muito em breve novo sorteio!"})}),p?.finished&&p?.winner_user_name&&(0,t.jsxs)(x,{children:["Vencedor do último sorteio ",(0,t.jsx)(g,{children:p?.winner_user_picture?(0,t.jsx)("img",{src:p?.winner_user_picture,width:25,height:25,style:{borderRadius:50}}):(0,t.jsx)("span",{style:{fontSize:14},children:"ツ"})}),(0,t.jsx)("b",{children:p?.winner_user_name})]}),(0,t.jsx)(O,{refresh:b,setFinallyRaffle:d,dateRaffle:p?.date}),(0,t.jsxs)(_,{children:[(0,t.jsx)("img",{width:200,src:"/images/mex.png"}),(0,t.jsx)(k,{children:"+"}),(0,t.jsx)("img",{width:150,src:"/images/mistery_box.webp"})]}),(0,t.jsxs)(u,{style:{gap:5},children:[(0,t.jsx)(A,{icon:"task_alt",title:"Regras de participação",description:"Assine um plano, aproveite o 1º mês grátis e, ao fazer seu primeiro pagamento e manter sua assinatura ativa, você ganha 1 bilhete para concorrer a brindes a cada 3 meses."}),(0,t.jsx)(f,{}),(0,t.jsx)(A,{icon:"confirmation_number",title:"Tenha mais sorte na hora de concorrer",description:"Indique amigos para fazer uma assinatura com seu código e ganhe +1 bilhete. Sem limite de indicações, mais amigos, mais bilhetes, mais chances!"}),(0,t.jsx)(f,{}),(0,t.jsx)(A,{icon:"av_timer",title:"Meus bilhetes permanecem para sempre?",description:"Todo assinante começa cada sorteio com 1 bilhete. Indique amigos e ganhe bilhetes extras para ter mais chances! Após cada sorteio, todos voltam para 1 bilhete, justo para todo mundo. 🎉"}),(0,t.jsx)(f,{}),(0,t.jsx)(A,{icon:"delivery_truck_speed",title:"Como funciona o envio dos brindes?",description:"Mantenha seu endereço e contato atualizados no perfil. Torçemos para que você seja o próximo ganhador! Se isso acontecer, entraremos em contato pelo WhatsApp ou E-mail para confirmar a entrega."}),(0,t.jsx)(f,{}),(0,t.jsx)(A,{icon:"domino_mask",title:"Proteção contra fraudes",description:"Para os golpistas de plantão: nossos sistemas identificam atividades suspeitas ao cancelar contas forjadas, garantindo que os sorteios sejam justos e seguros para todos os participantes."})]}),(0,t.jsx)(m,{target:"_blank",href:v,children:"Quero começar participar!"})]})})})}],35001)}]);